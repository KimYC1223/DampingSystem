...
namespace DampingSystem
{
    ...
    //=====================================================================================================================================
    /// <summary>
    /// <b>Vector3 damping system class based on second-order system</b><br />
    /// 2차 시스템으로 구현한 Vector3 타입의 감쇠 시스템의 클래스<br /><br />
    /// <b>Reference :</b>
    ...
    public class DampingSystemVector3 : DampingSystem<Vector3>
    {
        //=================================================================================================================================
        /// <summary>
        /// <b>Constructor of a Vector3 damping system class based on second-order system</b><br />
        /// 2차 시스템을 기반으로 한 Vector3 타입의 감쇠 시스템 클래스의 생성자
        /// </summary>
        ...
        public DampingSystemVector3(float frequency, float dampingRatio, float initialResponse, Vector3 initialCondition) : 
