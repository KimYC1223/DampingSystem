namespace DampingSystem
{
    ...
    //=====================================================================================================================================
    /// <summary>
    /// <b>Float damping system class based on second-order system</b><br />
    /// 2차 시스템으로 구현한 Float 타입의 감쇠 시스템의 클래스<br /><br />
    /// <b>Reference :</b>
    ...
    public class DampingSystemFloat : DampingSystem<float>
    {
        ...
        /// 감쇠 시스템의 초기 조건</param>
        //================================================================================================================================
        public DampingSystemFloat(float frequency, float dampingRatio, float initialResponse, float initialCondition) : 
