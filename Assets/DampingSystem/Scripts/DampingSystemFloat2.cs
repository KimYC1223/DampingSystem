...
namespace DampingSystem
{
    ...
    //=====================================================================================================================================
    /// <summary>
    /// <b>Float2 damping system class based on second-order system</b><br />
    /// 2차 시스템으로 구현한 Float2 타입의 감쇠 시스템의 클래스<br /><br />
    /// <b>Reference :</b>
    /// <a href="https://www.youtube.com/watch?v=KPoeNZZ6H4s">Giving Personality to Procedural Animations using Math</a>
    /// </summary>
    public class DampingSystemFloat2 : DampingSystem<float2>
    {
        //=================================================================================================================================
        /// <summary>
        ...
        /// 감쇠 시스템의 초기 조건</param>
        //================================================================================================================================
        public DampingSystemFloat2(float frequency, float dampingRatio, float initialResponse, float2 initialCondition) : 
            base(frequency, dampingRatio, initialResponse, initialCondition)
        {    
        }

        protected override float2 GetXd(float2 x, float dt)
        {
            return (x - Xp) / dt;
        }

        protected override float2 GetY(float dt)
        {
            return Y + dt * Yd;
        }

        protected override float2 GetYd(float k1_stable, float k2_stable, float2 x, float2 xd, float dt)
        {
